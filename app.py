...
from tabs_TTS.tab_odr.main import render as render_odr
from tabs_TTS.tab_doanhthu.main import render as render_doanhthu
from tabs_TTS.tab_opr.main import render as render_opr
